...
<script type="text/javascript">
	function changeNum() {
		...
		location.href="SelectGchServlet?num="+num;
	}
</script>
</head>
<body>
...
<div id="main" class="wrap">
	...
	<div class="main">
		<div class="price-off">
			...
			<div class="pager">
				<ul class="clearfix">
					<li ><a href="SelectGchServlet?num=1&id=${requestScope.gchid }">首页</a></li>
					<li><a 
						<c:if test="${requestScope.num==1}">href="SelectGchServlet?num=${requestScope.num}&id=${requestScope.gchid }" </c:if>
						  <c:if test="${requestScope.num!=1}">href="SelectGchServlet?num=${requestScope.num-1}&id=${requestScope.gchid }" </c:if>
						>上一页</a></li>
					<li><a 
						<c:if test="${requestScope.num==requestScope.pageCount }">href="SelectGchServlet?num=${requestScope.num}&id=${requestScope.gchid }" </c:if>
						  <c:if test="${requestScope.num!=requestScope.pageCount}">href="SelectGchServlet?num=${requestScope.num+1}&id=${requestScope.gchid }" </c:if>
						>下一页</a></li>
					<li><a href="SelectGchServlet?num=${requestScope.pageCount }&id=${requestScope.gchid }">尾页</a></li>
		...
		<div class="hot">
			<h2>热卖推荐</h2>
			<ul class="product clearfix">
				<c:forEach items="${sessionScope.hot }" var="hot">
				<li>
					<dl>

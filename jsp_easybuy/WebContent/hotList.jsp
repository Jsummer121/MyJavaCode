...
<script type="text/javascript">
	function changeNum() {
		...
		location.href="SelectBrandServlet?op=hot&num="+num;
	}
/* 	function onc() {
...
<div id="main" class="wrap">
	...
	<div class="main">
		<div class="price-off">
			...
			<div class="pager">
				<ul class="clearfix">
					<li ><a href="SelectBrandServlet?num=1&op=hot">首页</a></li>
					<li><a 
						<c:if test="${requestScope.num==1}">href="SelectBrandServlet?num=${requestScope.num}&op=hot" </c:if>
						  <c:if test="${requestScope.num!=1}">href="SelectBrandServlet?num=${requestScope.num-1}&op=hot" </c:if>
						>上一页</a></li>
					<li><a 
						<c:if test="${requestScope.num==requestScope.pageCount }">href="SelectBrandServlet?num=${requestScope.num}&op=hot" </c:if>
						  <c:if test="${requestScope.num!=requestScope.pageCount}">href="SelectBrandServlet?num=${requestScope.num+1}&op=hot" </c:if>
						>下一页</a></li>
					<li><a href="SelectBrandServlet?num=${requestScope.pageCount }&op=hot">尾页</a></li>

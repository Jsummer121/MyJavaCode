...
<script type="text/javascript">
	...
	$(function(){
		$("#btn").click(function(){
		 ...
		 var checkpass=$("#rePassWord").val();
		 	if(name==""||pass==""||checkpass==""){
		 		$("#msg").html("用户名，密码不能为空");
		 	}else{
		 		$.ajax({
				url:"RegServlet",
		...
		<div class="box">
			...
			<div id="form">
				<table>
					...
					<tr>
						<td></td>
						<td><label class="ui-green"><button id="btn">提交注册</button></label><span id="msg"></span></td>
					</tr>
